    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.experiences.update", [$experience->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('empresa') ? 'is-invalid' : '' }}" type="text" name="empresa" id="empresa" value="{{ old('empresa', $experience->empresa) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cargo') ? 'is-invalid' : '' }}" type="text" name="cargo" id="cargo" value="{{ old('cargo', $experience->cargo) }}">
                @if($errors->has('cargo'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_inicio') ? 'is-invalid' : '' }}" type="text" name="fecha_inicio" id="fecha_inicio" value="{{ old('fecha_inicio', $experience->fecha_inicio) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_final') ? 'is-invalid' : '' }}" type="text" name="fecha_final" id="fecha_final" value="{{ old('fecha_final', $experience->fecha_final) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('descripcion_del_cargo') ? 'is-invalid' : '' }}" name="descripcion_del_cargo" id="descripcion_del_cargo">{!! old('descripcion_del_cargo', $experience->descripcion_del_cargo) !!}</textarea>
