    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.universities.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_de_la_institucion') ? 'is-invalid' : '' }}" type="text" name="nombre_de_la_institucion" id="nombre_de_la_institucion" value="{{ old('nombre_de_la_institucion', '') }}">
